...
/**
 * Store sounds information into an array
 * Parameters:
 ...
 *      index(int): Position of array of storing
 * Return:
 *      (Void)
 */
void store_sounds(sounds_t sounds[], double x, double y, double level,
 ...
 * Parameters:
 *      location(*location_t): The pointer of location
 *      x(double): The X coordinate that needs to store into array
 *      y(double): The Y coordinate that needs to store into array
 * Return:
 *      (Void)
 ...
 * Parameters:
 *      data(sounds_t[]): The array that stores loudspeakers data
 *      x(double): X coordinate of the second point
 *      y(double): Y coordinate of the first point
 *      size_sounds(int): The number of sounds in the array
 * Return:
...
/**
 * Calculate sound level in new distance
 * Parameters:
...
/**
 * Stage one: Output a summary of sounds
 * Parameters:
...
/**
 * Stage two: Output sound level of each point
 * Parameters:
 *      sounds(sounds_t[]): The array that stores loudspeakers data
 *      locations(location_t[]): The array of locations
 *      x(double): X coordinate of the point
 *      y(double): Y coordinate of the point
 *      num_location(int): The number of locations in the array
 *      size_sounds(int): The number of sounds in the array
 * Return:
 *      (Void)
 */
...
/**
 * Stage three: Output a summary of 312 x 312 area
 * Parameters:
 *      sounds(sounds_t): The array that stores WAPs data
 *      size_sounds(int): The max number of data in the array
 * Return:
 *      (Void)
 */
void stage_three(sounds_t sounds[], int size_sounds){
...
/**
 * Stage four: Draw a 'sound map' with a grid
 * of character.
 * Parameters:
